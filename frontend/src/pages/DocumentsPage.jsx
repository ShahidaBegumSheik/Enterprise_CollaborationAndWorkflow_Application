...
export default function DocumentsPage() {
  ...
  return (    
    <div className="space-y-6">
      <div className="rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600 p-5 text-white shadow-2xl">
      ...
      <form onSubmit={handleUpload} className="rounded-2xl border-2 border-dashed border-sky-200 bg-white p-8 text-center shadow-xl">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-sky-100 text-3xl">📁</div>
